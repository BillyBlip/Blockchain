...
export const filledOrdersSelector = createSelector(
    ...
    (orders) => {
        ...
        // decorate orders ( give more attributes )
...
// Determines what the ether value is and what the token value is
// Decorate to human readable value
const decorateOrder = (order) => {
    let etherAmount
    let tokenAmount

    // Checks if it is the ether address
    ...
    return({
      ...
      tokenPrice,
      formattedTimestamp: moment.unix(order.timestamp).format('h:mm:ss a D/M') // formatted with moment
    })
}
...
const openOrders = state => {
    ...
    const openOrders = reject(all, (order) => {
        ...
        // Checks if the order is filled if so it will reject and not include it in open orders
